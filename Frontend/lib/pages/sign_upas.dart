...
class ArrowPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPath(
        path, paint..color = const Color.fromRGBO(174, 217, 224, 1));

    const TextSpan textSpan = TextSpan(
      style: TextStyle(color: Color.fromRGBO(174, 217, 224, 1)),
    );
    ...
    textPainter.layout();
    textPainter.paint(
        canvas, Offset(size.width * 0.2, 572)); // Adjusted text position
  }
...
class ArrowPainter2 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPath(
        path, paint..color = const Color.fromRGBO(255, 218, 185, 1));
